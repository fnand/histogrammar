...
| [Quantile](http://diana-hep.org/histogrammar/scala/latest/index.html#org.dianahep.histogrammar.Quantile$)        | Accumulate an adaptively binned histogram to compute approximate quantiles, such as the median. |
| [Bag](http://diana-hep.org/histogrammar/scala/latest/index.html#org.dianahep.histogrammar.Bag$)             | Accumulate raw data up to an optional limit, at which point only the total number are preserved. |
